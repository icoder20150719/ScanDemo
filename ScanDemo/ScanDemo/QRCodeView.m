...
+ (instancetype)viewWithFrame:(CGRect)frame maskInsets:(UIEdgeInsets)maskInsets aniamtionType:(NSUInteger)animationType{
    return [self viewWithFrame:frame maskInsets:maskInsets aniamtionType:animationType cornerColor:RGBCOLOR(25, 136, 222)];
}
...
+ (instancetype)viewWithFrame:(CGRect)frame maskInsets:(UIEdgeInsets)maskInsets aniamtionType:(NSUInteger)animationType cornerColor:(UIColor *)cornerColor{
    QRCodeView *view = [[QRCodeView alloc] initWithFrame:frame maskInsets:maskInsets aniamtionType:animationType cornerColor:cornerColor];
    return view;
}
...
- (instancetype)initWithFrame:(CGRect)frame maskInsets:(UIEdgeInsets)maskInsets aniamtionType:(NSUInteger)animationType{
    return [self initWithFrame:frame maskInsets:maskInsets aniamtionType:animationType cornerColor:RGBCOLOR(25, 136, 222)];
}
...
- (void)addDecorateLayer{
    ...
    CGColorRef marginLayerColor = RGBACOLOR(0.2, 0.2, 0.2, 0.6).CGColor;
...
#pragma mark 扫描区域的四个拐角
    {
        ...
        _borderLayer.strokeColor = RGBACOLOR(0.8, 0.8, 0.8, 0.4).CGColor;
